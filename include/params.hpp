...
struct Params {
  ...
  Params()
      : timeLimit(900),
        ...
        heuristicSemigreedyAlpha(0.15),
        heuristicSemigreedyIter(40000),
        heuristicSemigreedyTimeLimit(60),
        feasibilityRootNode(0),
        feasibilityRootNodeTimeLimit(300),
        feasibilityOtherNodes(0),
        ...
        preprocessing(true),
        pricingMethod(4),
        pricingHeur1Alpha(0.2),
        pricingHeur1MaxNCols(1000),
        pricingMaxColsPerIter(10),
        pricingExactTimeLimit(7200),
        branchingVariable(1) {};
