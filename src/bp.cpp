...
double Node::get_obj_value() const { return lp->get_obj_value(); }

bool Node::operator<(const Node &n) const {
  return (get_obj_value() < n.get_obj_value());
}

LP_STATE Node::solve() { return lp->optimize(); }
...
template <class Solution> void Node::save(Solution &sol) {
  std::cout << "Unimplemented function Node::save" << std::endl;
  abort;
}

int Node::get_n_columns() { return lp->get_n_columns(); }
...
template <class Solution> void BP<Solution>::solve(Node *root) {
...
template <class Solution> void BP<Solution>::push(Node *node) {
...
template <class Solution> void BP<Solution>::update_primal_bound(Node &node) {
...
template <class Solution> Node *BP<Solution>::top() { return L.back(); }

template <class Solution> void BP<Solution>::pop() {
  L.pop_back();
  return;
}

template <class Solution> int BP<Solution>::get_nodes() { return nodes; }

template <class Solution> double BP<Solution>::get_gap() {
...
template <class Solution> double BP<Solution>::get_primal_bound() {
  return primal_bound;
}

template <class Solution> double BP<Solution>::get_dual_bound() {
  return dual_bound;
};

template <class Solution> double BP<Solution>::get_time() { return time; }

template <class Solution> int BP<Solution>::get_opt_flag() { return opt_flag; }

template <class Solution> double BP<Solution>::calculate_dual_bound() {
...
template <class Solution> void BP<Solution>::show_stats(Node &node) {
